...
let blink = document.querySelector('homeCSS.blink');
const code = document.querySelector('homeCSS.code');
...
const ResetTerminal = () => {
	code.innerHTML = '<span class="homeCSS.blink">█</span>';
	blink = document.querySelector('homeCSS.blink');
};
