  ...
  <div className={artfourCSS.left}>
    <div className={artfourCSS.fant}>
      <div className={artfourCSS.f1}>
        ...
        <div className={artfourCSS.ojos3}></div></div>
    </div>
  </div>
...
​<section className={artfourCSS.prev}><Link to="/Artthree">Prev</Link></section>
    <section className={artfourCSS.next}><Link to="/Art">Next</Link></section> 
    </div>
  );
}
